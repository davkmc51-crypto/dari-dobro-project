  ...
  >
    <div className="mx-auto grid w-full max-w-[1400px] flex-1 content-center items-center gap-12 py-6 lg:grid-cols-[1fr_452px] lg:gap-14">
      <div className="animate-rise [animation-delay:0.08s]">
        ...
        <p className="mt-4 max-w-[52ch] text-[1.05rem] text-muted-foreground">Миссия АНО «Дари добро» — создание системы комплексной социальной поддержки нуждающихся граждан через предоставление адресной помощи, просветительскую деятельность и формирование культуры осознанного потребления, объединяя усилия общества для решения социальных проблем и улучшения качества жизни социально незащищенных групп населения.</p>
