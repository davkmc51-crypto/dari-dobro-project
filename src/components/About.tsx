...
const INTRO_TEXT =
  'Мы — фонд «Дари Добро» из Октябрьского. Помогаем детям-сиротам, пожилым людям, людям с инвалидностью и семьям, которым сейчас трудно: собираем вещи, продукты, деньги и находим тех, кто может помочь руками или временем.';

const HISTORY_TEXT =
  'АНО «Дари Добро» открылась в 2018 году — несколько человек начали собирать вещи для многодетных семей в Октябрьском. Сейчас у организации несколько постоянных программ и волонтёры, которые помогают на регулярной основе.';
          ...
          <figure className="grid gap-8 rounded-[var(--hero-radius)] bg-card p-8 shadow-[inset_0_0_0_1px_var(--hero-x-line)] lg:grid-cols-[auto_1fr] lg:p-12">
            ...
            <div>
              ...
              <blockquote className="mt-4 font-display text-xl leading-relaxed text-foreground lg:text-2xl">
                «Мы начинали с того, что развозили продукты нескольким семьям на своей машине. Сейчас
                у нас есть склад, регулярные отчёты и десятки волонтёров — и я хочу, чтобы помощь оставалась
                такой же простой и без лишней бюрократии».
              </blockquote>
