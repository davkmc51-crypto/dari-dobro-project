  ...
  <section id="documents" className="border-t bg-background px-5 py-20 lg:px-14 lg:py-28">
    <div className="mx-auto max-w-[1400px]">
      <SectionHeading
        ...
        title={
          <>
            Документы <em className="font-medium italic text-accent">и отчёты</em>
          </>
        }
        text="Учредительные документы, ежемесячные и годовые отчёты выложены здесь же — скачать может любой человек, без регистрации."
      />
