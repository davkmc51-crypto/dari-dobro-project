    ...
    <div className="mx-auto max-w-[1400px]">
      <div className="grid gap-12 lg:grid-cols-[1fr_1.15fr] lg:gap-20">
        <SectionHeading
          ...
          text="АНО «Дари Добро» работает в городе Октябрьский Республики Башкортостан. Мы не решаем проблемы за людей — мы становимся рядом в тот момент, когда своих сил уже не хватает: приносим продукты, помогаем с документами, готовим дом к зиме и остаёмся на связи дальше."
        />
