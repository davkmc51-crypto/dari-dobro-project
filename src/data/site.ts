...
export const PROJECTS: Project[] = [
  {
    ...
    icon: "Home",
    fullText: [
      "Проект «Тёплый дом» помогает семьям, оказавшимся в трудной жизненной ситуации, получить временное жильё — от нескольких недель до нескольких месяцев, пока люди не встанут на ноги.",
      "Мы работаем с семьями, пострадавшими от пожаров, домашнего насилия, потери жилья по другим причинам. Помогаем не только с крышей над головой, но и с базовыми вещами: мебелью, бытовой техникой, продуктами.",
      "Каждый случай рассматривается индивидуально: наши координаторы выезжают на место, оценивают ситуацию и подбирают подходящее решение.",
    ],
    results: [
      { value: "24", label: "семьи получили жильё" },
      { value: "5", label: "лет реализации проекта" },
    ],
  },
  {
    slug: "shag-v-buduschee",
    title: "«Шаг в будущее»",
    period: "Образование",
    ...
    icon: "GraduationCap",
    fullText: [
      "«Шаг в будущее» — программа профориентации и обучения для подростков из малообеспеченных и многодетных семей.",
      "Мы организуем мастер-классы, экскурсии на предприятия, встречи с профессионалами разных сфер, помогаем определиться с выбором профессии и получить дополнительные навыки.",
      "Отдельное направление — помощь с подготовкой к экзаменам и поступлением: бесплатные занятия с репетиторами и психологическая поддержка перед важными этапами.",
    ],
    results: [
      { value: "60+", label: "подростков в программе" },
      { value: "12", label: "партнёров-предприятий" },
    ],
  },
  {
    slug: "zdorove-ryadom",
    ...
    icon: "Stethoscope",
    fullText: [
      "«Здоровье рядом» — проект мобильных медицинских бригад, которые выезжают в отдалённые районы, где нет постоянного доступа к врачам-специалистам.",
      "В состав бригады входят терапевт, узкие специалисты и волонтёры-медики. Приём и базовая диагностика проводятся бесплатно, по итогам выдаются рекомендации и, при необходимости, помощь с направлением в профильные учреждения.",
      "Мы также организуем сбор и доставку лекарств и медицинских принадлежностей для пожилых людей и маломобильных граждан.",
    ],
    results: [
      { value: "9", label: "выездов бригады" },
      { value: "300+", label: "человек получили приём" },
    ],
  },
];
