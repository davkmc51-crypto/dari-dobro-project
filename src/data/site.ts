...
export const WHOM = [
  { icon: 'Baby', title: 'Семьи с детьми', text: 'Семьи с детьми в трудной жизненной ситуации.' },
  { icon: 'PersonStanding', title: 'Пожилые люди', text: 'Пожилые люди, оставшиеся без поддержки.' },
  { icon: 'Accessibility', title: 'Люди с инвалидностью', text: 'Люди с ограниченными возможностями здоровья.' },
  { icon: 'Home', title: 'Пострадавшие', text: 'Жертвы насилия или стихийных бедствий.' },
];
...
export const TEAM = [
  ...
  { name: 'Быстрова Алина Рамильевна', role: 'Руководитель проектов', text: '' },
  { name: 'Елена Козлова', role: 'PR-менеджер', text: '' },
  { name: 'Дмитрий Волков', role: 'Координатор волонтёров', text: '' },
];

export const AWARDS = [
  { year: '2022', title: 'Победитель конкурса «Лучший социальный проект»', text: '' },
  { year: '2023', title: 'Благодарность от Министерства социальной защиты', text: '' },
  { year: '2024', title: 'Грант Президентского фонда культурных инициатив', text: '' },
];

export const MEDIA = [
  { source: 'Первый канал', title: '«Доброе утро» — сюжет об организации', date: '' },
...
export const REPORTS_MONTHLY = [
  ...
  { title: 'Отчёт за февраль 2026', sum: '01.03.2026', icon: 'FileSpreadsheet' },
...
export const PARTNERS = [
  { name: 'ООО «ТехноГрупп»', contribution: 'Поддерживает миссию организации.' },
  { name: 'Банк «Добро»', contribution: 'Поддерживает миссию организации.' },
  { name: 'Агентство «Социум»', contribution: 'Поддерживает миссию организации.' },
...
export const HELP_STEPS = [
  { step: '01', title: 'Позвоните нам', text: `Свяжитесь с нами по телефону ${ORG.phone}.` },
  { step: '02', title: 'Или заполните форму', text: 'Оставьте заявку на сайте — это займёт минуту.' },
  { step: '03', title: 'Координатор свяжется', text: 'Мы перезвоним в течение 24 часов и вместе определим необходимый объём помощи.' },
];