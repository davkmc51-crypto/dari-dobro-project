...
export const CATALOG: CatalogItem[] = [
  {
    image: "item-1.jpg",
    title: "Тест для начинающих благотворителей",
    text: "Пройдите простой тест-анкету и получите бесплатный цифровой путеводитель по благотворительности: направления, советы и рекомендации по выбору надёжных фондов.",
    action: "Пройти тест",
  },
  {
    image: "item-2.jpg",
    title: "Подписка на эксклюзивные отчёты",
    text: "Недорогая ежемесячная подписка на видео- и фотоотчёты с мест, истории людей, которым вы помогли, и подробные отчёты о проектах фонда.",
