...
export const NEWS: NewsItem[] = [
  ...
  {
    id: 9,
    title: "Сбор средств на материалы для плетения «Браслетов выживания» для бойцов СВО",
    desc: "Помогаем нашим защитникам: собираем средства на паракорд для плетения браслетов выживания, которые выдерживают 80–100 кг на разрыв.",
    date: "16 сентября 2026",
    tags: ["акция", "помощь"],
    filter: "promo",
    image: "news-9.webp",
    href: "https://а-дари-добро.рф/Сбор%20средств%20на%20материалы%20для%20летения%20\"Браслетов%20выживания\"%20для%20бойцов%20СВО",
  },
  {
    id: 10,
    title: "Оказание помощи нуждающимся",
    desc: "Благотворительный фонд «Дари Добро» помогает, поддерживает и консультирует тех, кто оказался в трудной минуте.",
    date: "16 сентября 2026",
    tags: ["акция", "помощь"],
    filter: "promo",
    image: "news-10.webp",
    href: "https://а-дари-добро.рф/Оказание%20помощи%20нуждающимся",
  },
];
